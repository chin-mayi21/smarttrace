      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <StatusBadge status={currentListing.status} size="sm" />
          </div>
            ...
            <div className="divide-y divide-slate-100 text-xs">
              ...
              <div className={`p-4 grid grid-cols-1 md:grid-cols-12 gap-4 items-center ${
                ...
                <div className="md:col-span-3 text-right md:text-left">
                  <StatusBadge status={currentListing.comparison.mrp.status} size="sm" />
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                ...
                <div className="md:col-span-3 text-right md:text-left">
                  <StatusBadge status={currentListing.comparison.netQuantity.status} size="sm" />
              ...
              <div className={`p-4 grid grid-cols-1 md:grid-cols-12 gap-4 items-center ${
                ...
                <div className="md:col-span-3 text-right md:text-left">
                  <StatusBadge status={currentListing.comparison.countryOfOrigin.status} size="sm" />
        ...
        <div className="space-y-5 animate-in fade-in duration-200">
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-slate-500">Automated crawlers check 50+ listings in 1 batch against registered DPCR specifications.</p>
            </div>
            ...
            >
              ...
              <span>{isBatchScanning ? "Ingesting & Auditing 50 SKUs..." : "Re-Run Batch Crawl (50 SKUs)"}</span>
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
              ...
              <p className="text-2xl font-black text-slate-900 mt-1">50</p>
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
              ...
              <p className="text-2xl font-black text-emerald-700 mt-1">44 (88%)</p>
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
              ...
              <p className="text-2xl font-black text-rose-600 mt-1">6 (12%)</p>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden text-xs">
            <div className="p-4 bg-slate-50 border-b flex justify-between items-center">
              ...
              <button
                onClick={() => alert("Batch Statutory Show-Cause Notices served to 6 seller entities!")}
                className="px-3 py-1.5 bg-rose-700 text-white font-bold rounded-lg text-xs hover:bg-rose-600"
              >
                Serve Batch Section 36 Notices (6)
              </button>
            </div>
